...
public class Audio {
    public String sound = ""; // путь к файлу с фоновой музыкой
    private String shot = ""; // путь к файлу со звуком выстрела
    private String kill = ""; // путь к файлу со звуком смерти пришельца
    private Clip clip;
